...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="stream">
        <tr valign="top">
            ...
            <td>
                <a href="">
                    <xsl:attribute name="onclick">
                        var d=document.getElementById('<xsl:value-of select="../../../port"/>-<xsl:value-of
                            select="../../../server_index"/>-<xsl:value-of select="../../name"/>-<xsl:value-of
                            select="name"/>');
            ...
            <td align="middle">
                <xsl:value-of select="../../../server_index"/>
            </td>
            <td>
        ...
        <tr style="display:none">
            <xsl:attribute name="id">
                <xsl:value-of select="../../../port"/>-<xsl:value-of select="../../../server_index"/>-<xsl:value-of
                    select="../../name"/>-
                <xsl:value-of select="name"/>
            </xsl:attribute>
